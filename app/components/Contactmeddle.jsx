...
const Contactmeddle = () => {
  return (
   ...
   <div className='lg:grid grid-cols-2 items-center gap-x-4 '>
        {/* Search part */}
        <div className=''>
            <h2 className='font-bold md:text-4xl text-2xl text-[#151875] leading-[48px]'>Get In Touch</h2>
            <p className='md:pt-5 md:pb-[46px] mb-[20px] text-[#8A8FB9]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mattis neque ultrices  tristique amet erat vitae eget dolor los vitae lobortis quis bibendum quam.</p>
           <form action="">
            <div className='space-y-4 sm:space-y-0 sm:flex gap-x-4'>
            <input type="text" placeholder='Your Name*' className='sm:w-1/2 w-full  border-2 border-[#A4B6C8B2] px-[10px] py-[13px] outline-none'  />
            <input type="text" placeholder='Your E-mail' className='sm:w-1/2 w-full  border-2 border-[#A4B6C8B2] px-[10px] py-[13px] outline-none'/>
            </div>
