...
const ProductpageHeader = () => {
  return (
    <div className='pt-[124px] pb-[144px] lg:flex items-center justify-between'>
        <div className="">
            <h3 className='font-bold text-[22px] leading-[25px] pb-2 text-[#151875]'>Ecommerce Acceories & Fashion item </h3>
            <h6 className='text-sm text-[#8A8FB9] leading-[14px]'>About 9,620 results (0.62 seconds)</h6>
        </div>
        <div className="flex items-center gap-x-[26px]">
            <div className="flex items-center gap-x-2">
                <h4 className='text-base text-[#3F509E] font-normal leading-5'>Per Page</h4>
                <select className="w-[100px] h-[27px] pl-[11px] ml-[8px] bg-transparent border border-[#E7E6EF] text-[12px] text-[#8A8FB9] font-normal" name="" id="">
            ...
            <div className="flex items-center gap-x-1">
                ...
                <input  className="hidden lg:block w-[162px] h-[30px] pl-[7px] text-[#8A8FB9] font-normal border border-[#E7E6EF] outline-none" type="text" />
            </div>
        </div>
    </div>
  )
