...
const TopCategoriReuseabel = () => {
  return (
    <div className='group text-center'>
        <div className="relative w-full mx-auto  py-[45px] rounded-full bg-[#F6F7FB] overflow-hidden group-hover:shadow-[rgba(149,117,230,1)_-5px_5px_1px_2px] duration-300 ease-linear">
